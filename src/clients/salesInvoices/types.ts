...
/**
 * Interface for RSCollection[salesDispatches]
 */
export interface Rscollectionsalesdispatches {
  Meta?: Meta;
  items?: SalesDispatches[];
}
...
/**
 * SalesDispatches transaction line item
 *
 * Represents individual transaction records within a SalesInvoices collection.
 */
export interface SalesDispatches extends BaseEntity {
  GRPCODE?: number;
  TYPE?: number;
  IOCODE?: number;
  NUMBER?: string;
...
/**
 * SalesInvoices entity interface based on swagger definition
 */
export interface SalesInvoices extends BaseEntity {
  GRPCODE?: number;
  TYPE?: number;
  NUMBER?: string;
  DOC_TRACK_NR?: string;
  ...
  DISP_NUMBER?: string;
  DISPATCHES?: Rscollectionsalesdispatches;
  TRANSACTIONS?: RscollectionrsDesptransxml;
...
/**
 * Union type of all SalesInvoices field names for type-safe field selection and sorting
 */
export type SalesInvoicesField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'NUMBER'
...
/**
 * Type-safe sort specification for SalesInvoices queries
 */
export type SalesInvoicesSortSpec =
  | [SalesInvoicesField]
  | [SalesInvoicesField, 'asc' | 'desc']
  | [SalesInvoicesField[], 'asc' | 'desc']
  | [SalesInvoicesField[]];

/**
 * Type-safe query options for SalesInvoices entities
 *
 ...
 * ```
 */
export interface SalesInvoicesQueryOptions
  extends Omit<QueryOptions<SalesInvoicesField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: SalesInvoicesField[];
   ...
   */
  sort?: SalesInvoicesSortSpec;
}

/**
 * Search criteria for SalesInvoices entities
 *
 ...
 * ```
 */
export interface SalesInvoicesSearchCriteria {
  ...
  ek1acc?: StringFieldValue;
  ek1accref?: NumberFieldValue;
  ek2acc?: StringFieldValue;
  ek2accref?: NumberFieldValue;
  ek1cost?: StringFieldValue;
  ek1cref?: NumberFieldValue;
  ek2cost?: StringFieldValue;
  ek2cref?: NumberFieldValue;
  ek3acc?: StringFieldValue;
  ek3accref?: NumberFieldValue;
  ek4acc?: StringFieldValue;
  ek4accref?: NumberFieldValue;
  ek5acc?: StringFieldValue;
  ek5accref?: NumberFieldValue;
  ek3cost?: StringFieldValue;
  ek3cref?: NumberFieldValue;
  ek4cost?: StringFieldValue;
  ek4cref?: NumberFieldValue;
  ek5cost?: StringFieldValue;
  ek5cref?: NumberFieldValue;
  ...
  dataLinkReference?: NumberFieldValue;
  totalexaddtax?: NumberFieldValue;
  exaccounted?: NumberFieldValue;
  ...
  fromordwithpay?: NumberFieldValue;
  intelList?: DateFieldValue;
  ...
  posTransferInfo?: NumberFieldValue;
  taxFreeCheck?: NumberFieldValue;
  passportNo?: StringFieldValue;
  creditCardNo?: StringFieldValue;
  creditCardNumber?: StringFieldValue;
  approve?: NumberFieldValue;
  approveDate?: StringFieldValue;
  accFicheSiteid?: NumberFieldValue;
  preacclines?: DateFieldValue;
  entrust?: NumberFieldValue;
  ek3Per?: NumberFieldValue;
  ek3?: NumberFieldValue;
  ek4Per?: NumberFieldValue;
  ek4?: NumberFieldValue;
  ek5Per?: NumberFieldValue;
  ek5?: NumberFieldValue;
  ...
  payplanGlobalCode?: StringFieldValue;
  trcurrGlobalCode?: StringFieldValue;
  edtcurrGlobalCode?: StringFieldValue;
  cancelAutoGlProc?: NumberFieldValue;
  fillGlCodesConn?: NumberFieldValue;
  fillGlCodesCard?: NumberFieldValue;
  ...
  shiplocDef?: StringFieldValue;
  totalServices?: NumberFieldValue;
  fromexchdiff?: NumberFieldValue;
  eximvat?: NumberFieldValue;
  serialCode?: StringFieldValue;
  checkCldailydeductlimit?: NumberFieldValue;
  staffOtherExpenses?: NumberFieldValue;
  offerReference?: NumberFieldValue;
  noCalculate?: NumberFieldValue;
  ...
  eproducerStatus?: NumberFieldValue;
  eproducerSendmod?: NumberFieldValue;
  eproducerTaxnr?: StringFieldValue;
  eproducerTckno?: StringFieldValue;
  eproducerName?: StringFieldValue;
  eproducerSurname?: StringFieldValue;
  eproducerDefinition?: StringFieldValue;
  eproducerAddr1?: StringFieldValue;
  eproducerAddr2?: StringFieldValue;
  eproducerCitycode?: StringFieldValue;
  eproducerCity?: StringFieldValue;
  eproducerCountrycode?: StringFieldValue;
  eproducerCountry?: StringFieldValue;
  eproducerPostcode?: StringFieldValue;
  eproducerDistrictcode?: StringFieldValue;
  eproducerDistrict?: StringFieldValue;
  eproducerTowncode?: StringFieldValue;
  eproducerTown?: StringFieldValue;
  eproducerEmailaddr?: StringFieldValue;
  eproducerIscomp?: NumberFieldValue;
  eproducerDeliverydateorg?: NumberFieldValue;
  eproducerDeliverydate?: StringFieldValue;
  eproducerIspercurr?: NumberFieldValue;
  isOkcFiche?: NumberFieldValue;
  okcinfoList?: DateFieldValue;
  eximPaytyperef?: NumberFieldValue;
  eximPaytypeCode?: StringFieldValue;
  eximPaytypeName?: StringFieldValue;
  eximBrbankref?: NumberFieldValue;
  eximBrbankCode?: StringFieldValue;
  eximBrbankName?: StringFieldValue;
...
/**
 * Analytics data for SalesInvoices entities
 */
export interface SalesInvoicesAnalytics {
  total: number;
  // Add SalesInvoices-specific analytics fields
}
