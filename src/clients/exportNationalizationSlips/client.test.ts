import { ExportNationalizationSlipsClient } from './client';
import {
  ExportNationalizationSlips,
  ExportNationalizationSlipsField,
  ExportNationalizationSlipsSortSpec,
} from './types';
import { ApiClientConfig } from '../../types';

describe('ExportNationalizationSlipsClient', () => {
  let client: ExportNationalizationSlipsClient;
  ...
  beforeEach(() => {
    ...
    client = new ExportNationalizationSlipsClient(config);
  });
  ...
  describe('Basic CRUD Operations', () => {
    ...
    it('should get all exportNationalizationSlips', async () => {
      const mockResponse = {
        items: [
          {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/exportNationalizationSlips');
      expect(result).toEqual(mockResponse);
    });

    it('should get all exportNationalizationSlips with options', async () => {
      const options = {
        limit: 10,
        offset: 0,
        sort: ['TRCODE'] as ExportNationalizationSlipsSortSpec,
      };
      await client.getAll(options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/exportNationalizationSlips?limit=10&offset=0&sort=TRCODE'
      );
    });

    it('should get exportNationalizationSlips by ID', async () => {
      const mockExportNationalizationSlips: ExportNationalizationSlips = {
        INTERNAL_REFERENCE: 1,
        STATUS: 1,
      };
      jest.spyOn(client, 'request' as any).mockResolvedValue(mockExportNationalizationSlips);

      const result = await client.getById(1);

      expect(client['request']).toHaveBeenCalledWith('get', '/exportNationalizationSlips/1');
      expect(result).toEqual(mockExportNationalizationSlips);
    });

    it('should get exportNationalizationSlips by ID with options', async () => {
      const options = { expandLevel: 'full' };
      await client.getById(1, options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/exportNationalizationSlips/1?expandLevel=full'
      );
    });

    it('should create an new exportNationalizationSlips', async () => {
      const newExportNationalizationSlips = {
        STATUS: 1,
      };
      const createdExportNationalizationSlips: ExportNationalizationSlips = {
        ...newExportNationalizationSlips,
        INTERNAL_REFERENCE: 1,
      };
      jest.spyOn(client, 'request' as any).mockResolvedValue(createdExportNationalizationSlips);

      const result = await client.create(newExportNationalizationSlips);
      ...
      expect(result).toEqual(createdExportNationalizationSlips);
    });

    it('should update an exportNationalizationSlips', async () => {
      const updateExportNationalizationSlips = {
        INTERNAL_REFERENCE: 1,
        STATUS: 1,
      };
      jest.spyOn(client, 'request' as any).mockResolvedValue(updateExportNationalizationSlips);

      const result = await client.update(1, updateExportNationalizationSlips);

      expect(client['request']).toHaveBeenCalledWith(
        'put',
        '/exportNationalizationSlips/1',
        updateExportNationalizationSlips
      );
      expect(result).toEqual(updateExportNationalizationSlips);
    });

    it('should patch an exportNationalizationSlips', async () => {
    ...
    it('should delete an exportNationalizationSlips', async () => {
      jest.spyOn(client, 'request' as any).mockResolvedValue({ success: true });

      const result = await client.delete(1);

      expect(client['request']).toHaveBeenCalledWith('delete', '/exportNationalizationSlips/1');
      expect(result).toEqual({ success: true });
    });
  });
  ...
  describe('Search Methods', () => {
    ...
    it('should search exportNationalizationSlips', async () => {
  ...
  describe('Analytics Methods', () => {
    it('should get exportNationalizationSlips analytics', async () => {
    ...
    it('should get exportNationalizationSlips count', async () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should get database column properties', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/exportNationalizationSlips/dbcolumns'
      );
    ...
    it('should track changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/exportNationalizationSlips/track');
    ...
    it('should untrack changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/exportNationalizationSlips/untrack');
    ...
    it('should check track status', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/exportNationalizationSlips/checktrack'
      );
  ...
  describe('Error Handling', () => {
    it('should handle API errors gracefully', async () => {
      const apiError = new Error('API Error: ExportNationalizationSlips not found');
      jest.spyOn(client, 'request' as any).mockRejectedValue(apiError);

      await expect(client.getById(999)).rejects.toThrow(
        'API Error: ExportNationalizationSlips not found'
      );
    });
  ...
  describe('Custom Endpoint Methods', () => {
    it('should call reCalculateV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ReCalculate`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call reCalculateV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ReCalculate`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call reCalculateV1Get with query options', async () => {
      const options = {
        limit: 10,
        fields: ['TRCODE', 'FICHENO'] as ExportNationalizationSlipsField[],
      };
      jest.spyOn(client, 'request' as any).mockResolvedValue({ success: true });
    ...
    it('should call fillAccCodesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/FillAccCodes`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillAccCodesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/FillAccCodes`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyADiscountV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ApplyADiscount/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyADiscountV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ApplyADiscount/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setDefIntValueV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/SetDefIntValue/test/1/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setDefIntValueV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/SetDefIntValue/test/1/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call equalizePayAmntV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/EqualizePayAmnt`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call equalizePayAmntV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/EqualizePayAmnt`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addSeriLotsForKsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/AddSeriLotsForKs/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addSeriLotsForKsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/AddSeriLotsForKs/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillSMMACCCodesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/FillSMMACCCodes`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillSMMACCCodesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/FillSMMACCCodes`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByLRefV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/AttachADespatchByLRef/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByLRefV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/AttachADespatchByLRef/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByFicheNoV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/AttachADespatchByFicheNo/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByFicheNoV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/AttachADespatchByFicheNo/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call deleteCampaignV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/DeleteCampaign`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call deleteCampaignV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/DeleteCampaign`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setClientInfoV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/SetClientInfo`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setClientInfoV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/SetClientInfo`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getRelevantCampaignsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/GetRelevantCampaigns`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getRelevantCampaignsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/GetRelevantCampaigns`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignSpecificV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ApplyCampaignSpecific/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignSpecificV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ApplyCampaignSpecific/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ImportImage/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ImportImage/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportBase64EncodedImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ExportBase64EncodedImage/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportBase64EncodedImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ExportBase64EncodedImage/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importBase64EncodedImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ImportBase64EncodedImage/test/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importBase64EncodedImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ImportBase64EncodedImage/test/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistApplyaccdisttemplateV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistApplyaccdisttemplateV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSSL_LINESQCLISTVALLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSSL_LINESQCLISTVALLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistvallistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1/VALLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXMLV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ExportToXML/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXMLV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ExportToXML/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXMLFileV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ImportFromXMLFile/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXMLFileV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ImportFromXMLFile/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call createCompositeLinesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/CreateCompositeLines`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call createCompositeLinesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/CreateCompositeLines`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call formSeriLotLinesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/FormSeriLotLines/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call formSeriLotLinesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/FormSeriLotLines/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ApplyCampaign`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ApplyCampaign`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ApplyRePayPln/1/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ApplyRePayPln/1/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnForInvV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ApplyRePayPlnForInv/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnForInvV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ApplyRePayPlnForInv/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXmlStrV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ImportFromXmlStr/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXmlStrV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ImportFromXmlStr/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXmlStrV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ExportToXmlStr/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXmlStrV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ExportToXmlStr/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyConditionV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ApplyCondition`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyConditionV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ApplyCondition`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/ExportImage/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/ExportImage/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsGetstocklinepriceV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsGetstocklinepriceV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSSL_LINESV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSSL_LINESByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSSL_LINESQCLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSSL_LINESQCLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsslLinesqclistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/1/SL_LINES/1/QCLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesApplyaccdisttemplateV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesApplyaccdisttemplateV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSSL_LINESQCLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSSL_LINESQCLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSSL_LINESQCLISTVALLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSSL_LINESQCLISTVALLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesqclistvallistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/1/QCLIST/1/VALLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSDETAILSByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/DETAILS/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsdetailsAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/DETAILS/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call postReadWithBodyParametersV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/readwithbodyparamters`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call postReadByIdWithBodyParametersV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/1/readwithbodyparamters`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSSL_LINESV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getTRANSACTIONSSL_LINESByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/exportNationalizationSlips/1/TRANSACTIONS/1/SL_LINES/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call transactionsslLinesEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/exportNationalizationSlips/TRANSACTIONS/1/SL_LINES/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
