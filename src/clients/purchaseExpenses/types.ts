...
/**
 * PurchaseExpenses entity interface based on swagger definition
 */
export interface PurchaseExpenses extends BaseEntity {
  CARDTYPE?: number;
  CODE?: string;
  DESCRIPTION?: string;
  AUXIL_CODE?: string;
...
/**
 * Union type of all PurchaseExpenses field names for type-safe field selection and sorting
 */
export type PurchaseExpensesField =
  | 'INTERNAL_REFERENCE'
  | 'CARDTYPE'
  | 'RECORD_STATUS'
  | 'CODE'
...
/**
 * Type-safe sort specification for PurchaseExpenses queries
 */
export type PurchaseExpensesSortSpec =
  | [PurchaseExpensesField]
  | [PurchaseExpensesField, 'asc' | 'desc']
  | [PurchaseExpensesField[], 'asc' | 'desc']
  | [PurchaseExpensesField[]];

/**
 * Type-safe query options for PurchaseExpenses entities
 *
...
> {
   ...
   */
  sort?: PurchaseExpensesSortSpec;
}

/**
 * Search criteria for PurchaseExpenses entities
 *
 ...
 * ```
 */
export interface PurchaseExpensesSearchCriteria {
...
/**
 * Analytics data for PurchaseExpenses entities
 */
export interface PurchaseExpensesAnalytics {
  total: number;
  // Add PurchaseExpenses-specific analytics fields
}
