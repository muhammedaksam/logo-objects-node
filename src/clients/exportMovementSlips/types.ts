 ...
 *
 * Represents individual transaction records within a ExportMovementSlips collection.
 */
...
/**
 * ExportMovementSlips entity interface based on swagger definition
 */
export interface ExportMovementSlips extends BaseEntity {
  TRCODE?: number;
  FICHENO?: string;
  DATE?: string;
  FTIME?: number;
...
/**
 * Union type of all ExportMovementSlips field names for type-safe field selection and sorting
 */
export type ExportMovementSlipsField =
  | 'INTERNAL_REFERENCE'
  | 'TRCODE'
  | 'FICHENO'
  | 'DATE'
...
/**
 * Type-safe sort specification for ExportMovementSlips queries
 */
export type ExportMovementSlipsSortSpec =
  | [ExportMovementSlipsField]
  | [ExportMovementSlipsField, 'asc' | 'desc']
  | [ExportMovementSlipsField[], 'asc' | 'desc']
  | [ExportMovementSlipsField[]];

/**
 * Type-safe query options for ExportMovementSlips entities
 *
...
export interface ExportMovementSlipsQueryOptions
   ...
   */
  fields?: ExportMovementSlipsField[];
   ...
   */
  sort?: ExportMovementSlipsSortSpec;
}

/**
 * Search criteria for ExportMovementSlips entities
 *
 ...
 * ```
 */
export interface ExportMovementSlipsSearchCriteria {
...
/**
 * Analytics data for ExportMovementSlips entities
 */
export interface ExportMovementSlipsAnalytics {
  total: number;
  // Add ExportMovementSlips-specific analytics fields
}
