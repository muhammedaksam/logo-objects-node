 ...
 *
 * Represents individual transaction records within a SalesItemPrices collection.
 */
...
/**
 * SalesItemPrices entity interface based on swagger definition
 */
export interface SalesItemPrices extends BaseEntity {
  CARD_CODE?: string;
  OWNER_TYPE?: number;
  OWNER_CODE?: string;
  CARDREF?: number;
...
/**
 * Union type of all SalesItemPrices field names for type-safe field selection and sorting
 */
export type SalesItemPricesField =
  | 'INTERNAL_REFERENCE'
  | 'CARD_CODE'
  | 'OWNER_TYPE'
  | 'OWNER_CODE'
...
/**
 * Type-safe sort specification for SalesItemPrices queries
 */
export type SalesItemPricesSortSpec =
  | [SalesItemPricesField]
  | [SalesItemPricesField, 'asc' | 'desc']
  | [SalesItemPricesField[], 'asc' | 'desc']
  | [SalesItemPricesField[]];

/**
 * Type-safe query options for SalesItemPrices entities
 *
...
export interface SalesItemPricesQueryOptions
   ...
   */
  sort?: SalesItemPricesSortSpec;
}

/**
 * Search criteria for SalesItemPrices entities
 *
 ...
 * ```
 */
export interface SalesItemPricesSearchCriteria {
...
/**
 * Analytics data for SalesItemPrices entities
 */
export interface SalesItemPricesAnalytics {
  total: number;
  // Add SalesItemPrices-specific analytics fields
}
