 ...
 *
 * Represents individual transaction records within a ImportCreditLetters collection.
 */
...
/**
 * ImportCreditLetters entity interface based on swagger definition
 */
export interface ImportCreditLetters extends BaseEntity {
  TYP?: number;
  LETTER_NR?: string;
  ISSUE_DATE?: string;
  DUE_DATE?: string;
...
/**
 * Union type of all ImportCreditLetters field names for type-safe field selection and sorting
 */
export type ImportCreditLettersField =
  | 'INTERNAL_REFERENCE'
  | 'TYP'
  | 'LETTER_NR'
  | 'ISSUE_DATE'
...
/**
 * Type-safe sort specification for ImportCreditLetters queries
 */
export type ImportCreditLettersSortSpec =
  | [ImportCreditLettersField]
  | [ImportCreditLettersField, 'asc' | 'desc']
  | [ImportCreditLettersField[], 'asc' | 'desc']
  | [ImportCreditLettersField[]];

/**
 * Type-safe query options for ImportCreditLetters entities
 *
...
> {
   ...
   */
  fields?: ImportCreditLettersField[];
   ...
   */
  sort?: ImportCreditLettersSortSpec;
}

/**
 * Search criteria for ImportCreditLetters entities
 *
 ...
 * ```
 */
export interface ImportCreditLettersSearchCriteria {
...
/**
 * Analytics data for ImportCreditLetters entities
 */
export interface ImportCreditLettersAnalytics {
  total: number;
  // Add ImportCreditLetters-specific analytics fields
}
