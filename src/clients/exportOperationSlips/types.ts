 ...
 *
 * Represents individual transaction records within a ExportOperationSlips collection.
 */
...
/**
 * ExportOperationSlips entity interface based on swagger definition
 */
export interface ExportOperationSlips extends BaseEntity {
  GRPCODE?: number;
  TYPE?: number;
  NUMBER?: string;
  DOC_TRACK_NR?: string;
...
/**
 * Union type of all ExportOperationSlips field names for type-safe field selection and sorting
 */
export type ExportOperationSlipsField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'NUMBER'
...
/**
 * Type-safe sort specification for ExportOperationSlips queries
 */
export type ExportOperationSlipsSortSpec =
  | [ExportOperationSlipsField]
  | [ExportOperationSlipsField, 'asc' | 'desc']
  | [ExportOperationSlipsField[], 'asc' | 'desc']
  | [ExportOperationSlipsField[]];

/**
 * Type-safe query options for ExportOperationSlips entities
 *
 ...
 * ```
 */
export interface ExportOperationSlipsQueryOptions
  extends Omit<QueryOptions<ExportOperationSlipsField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: ExportOperationSlipsField[];
   ...
   */
  sort?: ExportOperationSlipsSortSpec;
}

/**
 * Search criteria for ExportOperationSlips entities
 *
 ...
 * ```
 */
export interface ExportOperationSlipsSearchCriteria {
...
/**
 * Analytics data for ExportOperationSlips entities
 */
export interface ExportOperationSlipsAnalytics {
  total: number;
  // Add ExportOperationSlips-specific analytics fields
}
