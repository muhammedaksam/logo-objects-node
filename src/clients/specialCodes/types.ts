...
/**
 * SpecialCodes entity interface based on swagger definition
 */
export interface SpecialCodes extends BaseEntity {
  CODE_TYPE?: number;
...
/**
 * Union type of all SpecialCodes field names for type-safe field selection and sorting
 */
export type SpecialCodesField =
  | 'INTERNAL_REFERENCE'
  | 'CODE_TYPE'
  | 'SPE_CODE_TYPE'
  | 'CODE'
...
/**
 * Type-safe sort specification for SpecialCodes queries
 */
export type SpecialCodesSortSpec =
  | [SpecialCodesField]
  | [SpecialCodesField, 'asc' | 'desc']
  | [SpecialCodesField[], 'asc' | 'desc']
  | [SpecialCodesField[]];

/**
 * Type-safe query options for SpecialCodes entities
 *
...
export interface SpecialCodesQueryOptions
   ...
   */
  sort?: SpecialCodesSortSpec;
}

/**
 * Search criteria for SpecialCodes entities
 *
 ...
 * ```
 */
export interface SpecialCodesSearchCriteria {
...
/**
 * Analytics data for SpecialCodes entities
 */
export interface SpecialCodesAnalytics {
  total: number;
  // Add SpecialCodes-specific analytics fields
}
