 ...
 *
 * Represents individual transaction records within a SalesCampaigns collection.
 */
...
/**
 * SalesCampaigns entity interface based on swagger definition
 */
export interface SalesCampaigns extends BaseEntity {
  CARD_TYPE?: number;
  CODE?: string;
  NAME?: string;
  AUXIL_CODE?: string;
...
/**
 * Union type of all SalesCampaigns field names for type-safe field selection and sorting
 */
export type SalesCampaignsField =
  | 'INTERNAL_REFERENCE'
  | 'RECORD_STATUS'
  | 'CARD_TYPE'
  | 'CODE'
...
/**
 * Type-safe sort specification for SalesCampaigns queries
 */
export type SalesCampaignsSortSpec =
  | [SalesCampaignsField]
  | [SalesCampaignsField, 'asc' | 'desc']
  | [SalesCampaignsField[], 'asc' | 'desc']
  | [SalesCampaignsField[]];

/**
 * Type-safe query options for SalesCampaigns entities
 *
...
> {
   ...
   */
  sort?: SalesCampaignsSortSpec;
}

/**
 * Search criteria for SalesCampaigns entities
 *
 ...
 * ```
 */
export interface SalesCampaignsSearchCriteria {
...
/**
 * Analytics data for SalesCampaigns entities
 */
export interface SalesCampaignsAnalytics {
  total: number;
  // Add SalesCampaigns-specific analytics fields
}
