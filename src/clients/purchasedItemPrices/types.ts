 ...
 *
 * Represents individual transaction records within a PurchasedItemPrices collection.
 */
...
/**
 * PurchasedItemPrices entity interface based on swagger definition
 */
export interface PurchasedItemPrices extends BaseEntity {
  CARD_CODE?: string;
  OWNER_TYPE?: number;
  OWNER_CODE?: string;
  CARDREF?: number;
...
/**
 * Union type of all PurchasedItemPrices field names for type-safe field selection and sorting
 */
export type PurchasedItemPricesField =
  | 'INTERNAL_REFERENCE'
  | 'CARD_CODE'
  | 'OWNER_TYPE'
  | 'OWNER_CODE'
...
/**
 * Type-safe sort specification for PurchasedItemPrices queries
 */
export type PurchasedItemPricesSortSpec =
  | [PurchasedItemPricesField]
  | [PurchasedItemPricesField, 'asc' | 'desc']
  | [PurchasedItemPricesField[], 'asc' | 'desc']
  | [PurchasedItemPricesField[]];

/**
 * Type-safe query options for PurchasedItemPrices entities
 *
 ...
 * ```
 */
export interface PurchasedItemPricesQueryOptions
  extends Omit<QueryOptions<PurchasedItemPricesField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: PurchasedItemPricesField[];
   ...
   */
  sort?: PurchasedItemPricesSortSpec;
}

/**
 * Search criteria for PurchasedItemPrices entities
 *
 ...
 * ```
 */
export interface PurchasedItemPricesSearchCriteria {
...
/**
 * Analytics data for PurchasedItemPrices entities
 */
export interface PurchasedItemPricesAnalytics {
  total: number;
  // Add PurchasedItemPrices-specific analytics fields
}
