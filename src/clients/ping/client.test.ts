...
import { Ping, PingField, PingSortSpec } from './types';
...
describe('PingClient', () => {
  ...
  describe('Basic CRUD Operations', () => {
    ...
    it('should get all pingClient', async () => {
      const mockResponse = {
        items: [
          {
    ...
    it('should get all pingClient with options', async () => {
      const options = { limit: 10, offset: 0, sort: ['INTERNAL_REFERENCE'] as PingSortSpec };
      await client.getAll(options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/ping?limit=10&offset=0&sort=INTERNAL_REFERENCE'
      );
    });
  });
  ...
  describe('Search Methods', () => {
    ...
    it('should search pingClient', async () => {
      const criteria = {};
  ...
  describe('Analytics Methods', () => {
    it('should get pingClient analytics', async () => {
    ...
    it('should get pingClient count', async () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should get database column properties', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/ping/dbcolumns');
    ...
    it('should track changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/ping/track');
    ...
    it('should untrack changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/ping/untrack');
    ...
    it('should check track status', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/ping/checktrack');
