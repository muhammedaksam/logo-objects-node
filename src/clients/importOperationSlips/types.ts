 ...
 *
 * Represents individual transaction records within a ImportOperationSlips collection.
 */
...
/**
 * ImportOperationSlips entity interface based on swagger definition
 */
export interface ImportOperationSlips extends BaseEntity {
  GRPCODE?: number;
  TYPE?: number;
  NUMBER?: string;
  DOC_TRACK_NR?: string;
...
/**
 * Union type of all ImportOperationSlips field names for type-safe field selection and sorting
 */
export type ImportOperationSlipsField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'NUMBER'
...
/**
 * Type-safe sort specification for ImportOperationSlips queries
 */
export type ImportOperationSlipsSortSpec =
  | [ImportOperationSlipsField]
  | [ImportOperationSlipsField, 'asc' | 'desc']
  | [ImportOperationSlipsField[], 'asc' | 'desc']
  | [ImportOperationSlipsField[]];

/**
 * Type-safe query options for ImportOperationSlips entities
 *
...
export interface ImportOperationSlipsQueryOptions
   ...
   */
  fields?: ImportOperationSlipsField[];
   ...
   */
  sort?: ImportOperationSlipsSortSpec;
}

/**
 * Search criteria for ImportOperationSlips entities
 *
 ...
 * ```
 */
export interface ImportOperationSlipsSearchCriteria {
...
/**
 * Analytics data for ImportOperationSlips entities
 */
export interface ImportOperationSlipsAnalytics {
  total: number;
  // Add ImportOperationSlips-specific analytics fields
}
