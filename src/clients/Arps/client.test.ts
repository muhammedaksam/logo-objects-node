import { ArpsClient } from './client';
import { Arps, ArpsField, ArpsSortSpec } from './types';
import { ApiClientConfig } from '../../types';

describe('ArpsClient', () => {
  let client: ArpsClient;
  ...
  describe('Basic CRUD Operations', () => {
    ...
    it('should get all arps', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/Arps');
      expect(result).toEqual(mockResponse);
    });

    it('should get all arps with options', async () => {
      const options = { limit: 10, offset: 0, sort: ['ACCOUNT_TYPE'] as ArpsSortSpec };
      await client.getAll(options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/Arps?limit=10&offset=0&sort=ACCOUNT_TYPE'
      );
    });

    it('should get arps by ID', async () => {
      const mockArps: Arps = {
        INTERNAL_REFERENCE: 1,
        CODE: 'Test CODE',
        NAME: 'Test NAME',
      ...
      jest.spyOn(client, 'request' as any).mockResolvedValue(mockArps);

      const result = await client.getById(1);

      expect(client['request']).toHaveBeenCalledWith('get', '/Arps/1');
      expect(result).toEqual(mockArps);
    });

    it('should get arps by ID with options', async () => {
      const options = { expandLevel: 'full' };
      await client.getById(1, options);

      expect(client['request']).toHaveBeenCalledWith('get', '/Arps/1?expandLevel=full');
    });

    it('should create an new arps', async () => {
      const newArps = {
        CODE: 'Test CODE',
        NAME: 'Test NAME',
        TITLE: 'Test TITLE',
      };
      const createdArps: Arps = { ...newArps, INTERNAL_REFERENCE: 1 };
      jest.spyOn(client, 'request' as any).mockResolvedValue(createdArps);

      const result = await client.create(newArps);

      expect(client['request']).toHaveBeenCalledWith('post', '/Arps', newArps);
      expect(result).toEqual(createdArps);
    });

    it('should update an arps', async () => {
      const updateArps = {
        INTERNAL_REFERENCE: 1,
        CODE: 'Test CODE',
        NAME: 'Test NAME',
      ...
      jest.spyOn(client, 'request' as any).mockResolvedValue(updateArps);

      const result = await client.update(1, updateArps);

      expect(client['request']).toHaveBeenCalledWith('put', '/Arps/1', updateArps);
      expect(result).toEqual(updateArps);
    });

    it('should patch an arps', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('patch', '/Arps/1', patchData);
      expect(result).toEqual({ success: true });
    });

    it('should delete an arps', async () => {
      jest.spyOn(client, 'request' as any).mockResolvedValue({ success: true });

      const result = await client.delete(1);

      expect(client['request']).toHaveBeenCalledWith('delete', '/Arps/1');
      expect(result).toEqual({ success: true });
    });
  });
  ...
  describe('Analytics Methods', () => {
    it('should get arps analytics', async () => {
    ...
    it('should get arps count', async () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should get database column properties', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/Arps/dbcolumns');
    ...
    it('should track changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/Arps/track');
    ...
    it('should untrack changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/Arps/untrack');
    ...
    it('should check track status', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/Arps/checktrack');
  ...
  describe('Error Handling', () => {
    it('should handle API errors gracefully', async () => {
      const apiError = new Error('API Error: Arps not found');
      jest.spyOn(client, 'request' as any).mockRejectedValue(apiError);

      await expect(client.getById(999)).rejects.toThrow('API Error: Arps not found');
    });
  ...
  describe('Custom Endpoint Methods', () => {
    it('should call reCalculateV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/ReCalculate`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call reCalculateV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ReCalculate`);
      expect(result).toEqual({ success: true });
    });

    it('should call reCalculateV1Get with query options', async () => {
      const options = { limit: 10, fields: ['ACCOUNT_TYPE', 'CODE'] as ArpsField[] };
      jest.spyOn(client, 'request' as any).mockResolvedValue({ success: true });
    ...
    it('should call fillAccCodesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/FillAccCodes`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillAccCodesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/FillAccCodes`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyADiscountV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ApplyADiscount/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyADiscountV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/ApplyADiscount/test`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setDefIntValueV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/SetDefIntValue/test/1/1/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setDefIntValueV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/SetDefIntValue/test/1/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call equalizePayAmntV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/EqualizePayAmnt`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call equalizePayAmntV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/EqualizePayAmnt`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addSeriLotsForKsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/AddSeriLotsForKs/test/1/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addSeriLotsForKsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/AddSeriLotsForKs/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillSMMACCCodesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/FillSMMACCCodes`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillSMMACCCodesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/FillSMMACCCodes`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByLRefV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/AttachADespatchByLRef/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByFicheNoV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/AttachADespatchByFicheNo/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByFicheNoV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/AttachADespatchByFicheNo/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call deleteCampaignV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/DeleteCampaign`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call deleteCampaignV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/DeleteCampaign`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setClientInfoV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/SetClientInfo`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setClientInfoV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/SetClientInfo`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getRelevantCampaignsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/GetRelevantCampaigns`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignSpecificV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ApplyCampaignSpecific/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignSpecificV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/ApplyCampaignSpecific/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ImportImage/test/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportBase64EncodedImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/ExportBase64EncodedImage/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportBase64EncodedImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/ExportBase64EncodedImage/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importBase64EncodedImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/ImportBase64EncodedImage/test/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importBase64EncodedImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/ImportBase64EncodedImage/test/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistApplyaccdisttemplateV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistApplyaccdisttemplateV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/GENIUSFLDSLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/GENIUSFLDSLIST/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getDEFNFLDSLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/DEFNFLDSLIST`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getDEFNFLDSLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/DEFNFLDSLIST/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/DEFNFLDSLIST/AppendLine2`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/DEFNFLDSLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/DEFNFLDSLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/DEFNFLDSLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/DEFNFLDSLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/DEFNFLDSLIST/AddLine2/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/DEFNFLDSLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/DEFNFLDSLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/DEFNFLDSLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/DEFNFLDSLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/DEFNFLDSLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/DEFNFLDSLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/DEFNFLDSLIST/SetLineTotals/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call defnfldslistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/DEFNFLDSLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXMLV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ExportToXML/test/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXMLFileV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ImportFromXMLFile/test/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXMLFileV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/ImportFromXMLFile/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call createCompositeLinesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/CreateCompositeLines`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call formSeriLotLinesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/FormSeriLotLines/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call formSeriLotLinesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/FormSeriLotLines/1`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ApplyCampaign`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/ApplyCampaign`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ApplyRePayPln/1/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnForInvV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ApplyRePayPlnForInv/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXmlStrV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ImportFromXmlStr/test/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXmlStrV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/ImportFromXmlStr/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXmlStrV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ExportToXmlStr/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXmlStrV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/ExportToXmlStr/test`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyConditionV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ApplyCondition`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyConditionV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/ApplyCondition`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/ExportImage/test/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getNOTESV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getNOTESByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES/AppendLine2`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/NOTES/AppendLine2`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/NOTES/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/NOTES/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES/GetStockLinePrice/1/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/NOTES/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES/AddLine2/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/Arps/NOTES/AddLine2/1`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/NOTES/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/NOTES/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES/EqualizeBalance/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/NOTES/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/NOTES/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call notesSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/NOTES/SetLineTotals/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getGENIUSFLDSLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/GENIUSFLDSLIST`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getGENIUSFLDSLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/GENIUSFLDSLIST/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/GENIUSFLDSLIST/AppendLine2`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/GENIUSFLDSLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/GENIUSFLDSLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/Arps/1/GENIUSFLDSLIST/AddLine2/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/GENIUSFLDSLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/Arps/1/GENIUSFLDSLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call geniusfldslistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/Arps/GENIUSFLDSLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
