 ...
 *
 * Represents individual transaction records within a PurchaseDispatches collection.
 */
...
/**
 * PurchaseDispatches entity interface based on swagger definition
 */
...
/**
 * Union type of all PurchaseDispatches field names for type-safe field selection and sorting
 */
export type PurchaseDispatchesField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'IOCODE'
...
/**
 * Type-safe sort specification for PurchaseDispatches queries
 */
export type PurchaseDispatchesSortSpec =
  | [PurchaseDispatchesField]
  | [PurchaseDispatchesField, 'asc' | 'desc']
  | [PurchaseDispatchesField[], 'asc' | 'desc']
  | [PurchaseDispatchesField[]];

/**
 * Type-safe query options for PurchaseDispatches entities
 *
...
> {
   ...
   */
  fields?: PurchaseDispatchesField[];
   ...
   */
  sort?: PurchaseDispatchesSortSpec;
}

/**
 * Search criteria for PurchaseDispatches entities
 *
 ...
 * ```
 */
export interface PurchaseDispatchesSearchCriteria {
...
/**
 * Analytics data for PurchaseDispatches entities
 */
export interface PurchaseDispatchesAnalytics {
  total: number;
  // Add PurchaseDispatches-specific analytics fields
}
