 ...
 *
 * Represents individual transaction records within a PurchaseProposalOrders collection.
 */
...
/**
 * PurchaseProposalOrders entity interface based on swagger definition
 */
export interface PurchaseProposalOrders extends BaseEntity {
  TRCODE?: number;
  FICHENO?: string;
  DATE?: string;
  TIME?: number;
...
/**
 * Union type of all PurchaseProposalOrders field names for type-safe field selection and sorting
 */
export type PurchaseProposalOrdersField =
  | 'INTERNAL_REFERENCE'
  | 'TRCODE'
  | 'FICHENO'
  | 'DATE'
...
/**
 * Type-safe sort specification for PurchaseProposalOrders queries
 */
export type PurchaseProposalOrdersSortSpec =
  | [PurchaseProposalOrdersField]
  | [PurchaseProposalOrdersField, 'asc' | 'desc']
  | [PurchaseProposalOrdersField[], 'asc' | 'desc']
  | [PurchaseProposalOrdersField[]];

/**
 * Type-safe query options for PurchaseProposalOrders entities
 *
 ...
 * ```
 */
export interface PurchaseProposalOrdersQueryOptions
  extends Omit<QueryOptions<PurchaseProposalOrdersField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: PurchaseProposalOrdersField[];
   ...
   */
  sort?: PurchaseProposalOrdersSortSpec;
}

/**
 * Search criteria for PurchaseProposalOrders entities
 *
 ...
 * ```
 */
export interface PurchaseProposalOrdersSearchCriteria {
...
/**
 * Analytics data for PurchaseProposalOrders entities
 */
export interface PurchaseProposalOrdersAnalytics {
  total: number;
  // Add PurchaseProposalOrders-specific analytics fields
}
