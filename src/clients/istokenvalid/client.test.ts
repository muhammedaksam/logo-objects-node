import { IstokenvalidClient } from './client';
import { Istokenvalid, IstokenvalidField, IstokenvalidSortSpec } from './types';
import { ApiClientConfig } from '../../types';

describe('IstokenvalidClient', () => {
  let client: IstokenvalidClient;
  ...
  beforeEach(() => {
    ...
    client = new IstokenvalidClient(config);
  });
  ...
  describe('Basic CRUD Operations', () => {
    ...
    it('should get all istokenvalid', async () => {
      const mockResponse = {
        items: [
          {
    ...
    it('should get all istokenvalid with options', async () => {
      const options = {
        limit: 10,
        offset: 0,
        sort: ['INTERNAL_REFERENCE'] as IstokenvalidSortSpec,
      };
      await client.getAll(options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/istokenvalid?limit=10&offset=0&sort=INTERNAL_REFERENCE'
      );
    });
  });
  ...
  describe('Search Methods', () => {
    ...
    it('should search istokenvalid', async () => {
      const criteria = {};
  ...
  describe('Analytics Methods', () => {
    it('should get istokenvalid analytics', async () => {
    ...
    it('should get istokenvalid count', async () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should get database column properties', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/istokenvalid/dbcolumns');
    ...
    it('should track changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/istokenvalid/track');
    ...
    it('should untrack changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/istokenvalid/untrack');
    ...
    it('should check track status', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/istokenvalid/checktrack');
