 ...
 *
 * Represents individual transaction records within a PurchaseProposalOffers collection.
 */
...
/**
 * PurchaseProposalOffers entity interface based on swagger definition
 */
export interface PurchaseProposalOffers extends BaseEntity {
  TRCODE?: number;
  FICHENO?: string;
  DATE?: string;
  TIME?: number;
...
/**
 * Union type of all PurchaseProposalOffers field names for type-safe field selection and sorting
 */
export type PurchaseProposalOffersField =
  | 'INTERNAL_REFERENCE'
  | 'TRCODE'
  | 'FICHENO'
  | 'DATE'
...
/**
 * Type-safe sort specification for PurchaseProposalOffers queries
 */
export type PurchaseProposalOffersSortSpec =
  | [PurchaseProposalOffersField]
  | [PurchaseProposalOffersField, 'asc' | 'desc']
  | [PurchaseProposalOffersField[], 'asc' | 'desc']
  | [PurchaseProposalOffersField[]];

/**
 * Type-safe query options for PurchaseProposalOffers entities
 *
...
> {
   ...
   */
  fields?: PurchaseProposalOffersField[];
   ...
   */
  sort?: PurchaseProposalOffersSortSpec;
}

/**
 * Search criteria for PurchaseProposalOffers entities
 *
 ...
 * ```
 */
export interface PurchaseProposalOffersSearchCriteria {
...
/**
 * Analytics data for PurchaseProposalOffers entities
 */
export interface PurchaseProposalOffersAnalytics {
  total: number;
  // Add PurchaseProposalOffers-specific analytics fields
}
