 ...
 *
 * Represents individual transaction records within a PurchaseInvoices collection.
 */
...
/**
 * PurchaseInvoices entity interface based on swagger definition
 */
...
/**
 * Union type of all PurchaseInvoices field names for type-safe field selection and sorting
 */
export type PurchaseInvoicesField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'NUMBER'
...
/**
 * Type-safe sort specification for PurchaseInvoices queries
 */
export type PurchaseInvoicesSortSpec =
  | [PurchaseInvoicesField]
  | [PurchaseInvoicesField, 'asc' | 'desc']
  | [PurchaseInvoicesField[], 'asc' | 'desc']
  | [PurchaseInvoicesField[]];

/**
 * Type-safe query options for PurchaseInvoices entities
 *
 ...
 * ```
 */
export interface PurchaseInvoicesQueryOptions
  extends Omit<QueryOptions<PurchaseInvoicesField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: PurchaseInvoicesField[];
   ...
   */
  sort?: PurchaseInvoicesSortSpec;
}

/**
 * Search criteria for PurchaseInvoices entities
 *
 ...
 * ```
 */
export interface PurchaseInvoicesSearchCriteria {
...
/**
 * Analytics data for PurchaseInvoices entities
 */
export interface PurchaseInvoicesAnalytics {
  total: number;
  // Add PurchaseInvoices-specific analytics fields
}
