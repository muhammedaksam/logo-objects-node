 ...
 *
 * Represents individual transaction records within a ExportTypedSalesInvoices collection.
 */
...
/**
 * ExportTypedSalesInvoices entity interface based on swagger definition
 */
export interface ExportTypedSalesInvoices extends BaseEntity {
  GRPCODE?: number;
  TYPE?: number;
  NUMBER?: string;
  DOC_TRACK_NR?: string;
...
/**
 * Union type of all ExportTypedSalesInvoices field names for type-safe field selection and sorting
 */
export type ExportTypedSalesInvoicesField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'NUMBER'
...
/**
 * Type-safe sort specification for ExportTypedSalesInvoices queries
 */
export type ExportTypedSalesInvoicesSortSpec =
  | [ExportTypedSalesInvoicesField]
  | [ExportTypedSalesInvoicesField, 'asc' | 'desc']
  | [ExportTypedSalesInvoicesField[], 'asc' | 'desc']
  | [ExportTypedSalesInvoicesField[]];

/**
 * Type-safe query options for ExportTypedSalesInvoices entities
 *
...
export interface ExportTypedSalesInvoicesQueryOptions
   ...
   */
  fields?: ExportTypedSalesInvoicesField[];
   ...
   */
  sort?: ExportTypedSalesInvoicesSortSpec;
}

/**
 * Search criteria for ExportTypedSalesInvoices entities
 *
 ...
 * ```
 */
export interface ExportTypedSalesInvoicesSearchCriteria {
...
/**
 * Analytics data for ExportTypedSalesInvoices entities
 */
export interface ExportTypedSalesInvoicesAnalytics {
  total: number;
  // Add ExportTypedSalesInvoices-specific analytics fields
}
