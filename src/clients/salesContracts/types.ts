 ...
 *
 * Represents individual transaction records within a SalesContracts collection.
 */
...
/**
 * SalesContracts entity interface based on swagger definition
 */
export interface SalesContracts extends BaseEntity {
  TRCODE?: number;
  FICHENO?: string;
  DATE?: string;
  TIME?: number;
...
/**
 * Union type of all SalesContracts field names for type-safe field selection and sorting
 */
export type SalesContractsField =
  | 'INTERNAL_REFERENCE'
  | 'TRCODE'
  | 'FICHENO'
  | 'DATE'
...
/**
 * Type-safe sort specification for SalesContracts queries
 */
export type SalesContractsSortSpec =
  | [SalesContractsField]
  | [SalesContractsField, 'asc' | 'desc']
  | [SalesContractsField[], 'asc' | 'desc']
  | [SalesContractsField[]];

/**
 * Type-safe query options for SalesContracts entities
 *
 ...
 * ```
 */
export interface SalesContractsQueryOptions
  extends Omit<QueryOptions<SalesContractsField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: SalesContractsField[];
   ...
   */
  sort?: SalesContractsSortSpec;
}

/**
 * Search criteria for SalesContracts entities
 *
 ...
 * ```
 */
export interface SalesContractsSearchCriteria {
...
/**
 * Analytics data for SalesContracts entities
 */
export interface SalesContractsAnalytics {
  total: number;
  // Add SalesContracts-specific analytics fields
}
