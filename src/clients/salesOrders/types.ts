 ...
 *
 * Represents individual transaction records within a SalesOrders collection.
 */
...
/**
 * SalesOrders entity interface based on swagger definition
 */
export interface SalesOrders extends BaseEntity {
  TYPE?: number;
  NUMBER?: string;
  DOC_TRACK_NR?: string;
  DATE?: string;
...
/**
 * Union type of all SalesOrders field names for type-safe field selection and sorting
 */
export type SalesOrdersField =
  | 'INTERNAL_REFERENCE'
  | 'TYPE'
  | 'NUMBER'
  | 'DOC_TRACK_NR'
...
/**
 * Type-safe sort specification for SalesOrders queries
 */
export type SalesOrdersSortSpec =
  | [SalesOrdersField]
  | [SalesOrdersField, 'asc' | 'desc']
  | [SalesOrdersField[], 'asc' | 'desc']
  | [SalesOrdersField[]];

/**
 * Type-safe query options for SalesOrders entities
 *
...
export interface SalesOrdersQueryOptions
   ...
   */
  sort?: SalesOrdersSortSpec;
}

/**
 * Search criteria for SalesOrders entities
 *
 ...
 * ```
 */
export interface SalesOrdersSearchCriteria {
...
/**
 * Analytics data for SalesOrders entities
 */
export interface SalesOrdersAnalytics {
  total: number;
  // Add SalesOrders-specific analytics fields
}
