...
/**
 * GroupCodes entity interface based on swagger definition
 */
export interface GroupCodes extends BaseEntity {
  CODE_TYPE?: number;
...
/**
 * Union type of all GroupCodes field names for type-safe field selection and sorting
 */
export type GroupCodesField =
  | 'INTERNAL_REFERENCE'
  | 'CODE_TYPE'
  | 'SPE_CODE_TYPE'
  | 'CODE'
...
/**
 * Type-safe sort specification for GroupCodes queries
 */
export type GroupCodesSortSpec =
  | [GroupCodesField]
  | [GroupCodesField, 'asc' | 'desc']
  | [GroupCodesField[], 'asc' | 'desc']
  | [GroupCodesField[]];

/**
 * Type-safe query options for GroupCodes entities
 *
...
export interface GroupCodesQueryOptions
   ...
   */
  sort?: GroupCodesSortSpec;
}

/**
 * Search criteria for GroupCodes entities
 *
 ...
 * ```
 */
export interface GroupCodesSearchCriteria {
...
/**
 * Analytics data for GroupCodes entities
 */
export interface GroupCodesAnalytics {
  total: number;
  // Add GroupCodes-specific analytics fields
}
