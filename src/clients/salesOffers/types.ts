 ...
 *
 * Represents individual transaction records within a SalesOffers collection.
 */
...
/**
 * SalesOffers entity interface based on swagger definition
 */
export interface SalesOffers extends BaseEntity {
  TRCODE?: number;
  FICHENO?: string;
  DATE?: string;
  TIME?: number;
...
/**
 * Union type of all SalesOffers field names for type-safe field selection and sorting
 */
export type SalesOffersField =
  | 'INTERNAL_REFERENCE'
  | 'TRCODE'
  | 'FICHENO'
  | 'DATE'
...
/**
 * Type-safe sort specification for SalesOffers queries
 */
export type SalesOffersSortSpec =
  | [SalesOffersField]
  | [SalesOffersField, 'asc' | 'desc']
  | [SalesOffersField[], 'asc' | 'desc']
  | [SalesOffersField[]];

/**
 * Type-safe query options for SalesOffers entities
 *
...
> {
   ...
   */
  sort?: SalesOffersSortSpec;
}

/**
 * Search criteria for SalesOffers entities
 *
 ...
 * ```
 */
export interface SalesOffersSearchCriteria {
...
/**
 * Analytics data for SalesOffers entities
 */
export interface SalesOffersAnalytics {
  total: number;
  // Add SalesOffers-specific analytics fields
}
