 ...
 *
 * Represents individual transaction records within a SalesDispatches collection.
 */
...
/**
 * SalesDispatches entity interface based on swagger definition
 */
...
/**
 * Union type of all SalesDispatches field names for type-safe field selection and sorting
 */
export type SalesDispatchesField =
  | 'INTERNAL_REFERENCE'
  | 'GRPCODE'
  | 'TYPE'
  | 'IOCODE'
  ...
  | 'EINVOICE_BUYERCLIENTREF'
  | 'EINVOICE_BUYERCLIENTCODE'
  | 'EINVOICE_TAXNRTOPAY'
  ...
  | 'EARCHIVEDETR_BUYERCLIENTREF'
  | 'EARCHIVEDETR_BUYERCLIENTCODE'
  | 'EPRODUCER_STATUS'
  | 'EPRODUCER_SENDMOD'
  | 'EPRODUCER_TAXNR'
  | 'EPRODUCER_TCKNO'
...
/**
 * Type-safe sort specification for SalesDispatches queries
 */
export type SalesDispatchesSortSpec =
  | [SalesDispatchesField]
  | [SalesDispatchesField, 'asc' | 'desc']
  | [SalesDispatchesField[], 'asc' | 'desc']
  | [SalesDispatchesField[]];

/**
 * Type-safe query options for SalesDispatches entities
 *
 ...
 * ```
 */
export interface SalesDispatchesQueryOptions
  extends Omit<QueryOptions<SalesDispatchesField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: SalesDispatchesField[];
   ...
   */
  sort?: SalesDispatchesSortSpec;
}

/**
 * Search criteria for SalesDispatches entities
 *
...
export interface SalesDispatchesSearchCriteria {
  ...
  sourcepolnref?: NumberFieldValue;
  ...
  invoiced?: NumberFieldValue;
  glPosted?: NumberFieldValue;
  inuse?: NumberFieldValue;
  invoiceType?: NumberFieldValue;
  ...
  shpInfRef?: NumberFieldValue;
  eximWhFicheref?: NumberFieldValue;
  eximWhFicheno?: StringFieldValue;
  eximFicheType?: NumberFieldValue;
  currTransaction?: NumberFieldValue;
  ...
  exchinfoDistExpenses?: NumberFieldValue;
  ...
  dispStatus?: NumberFieldValue;
  autofillSldetails?: NumberFieldValue;
  mainMfReference?: NumberFieldValue;
  mainMfSiteid?: NumberFieldValue;
  ...
  einvoiceBuyerclientref?: NumberFieldValue;
  einvoiceBuyerclientcode?: StringFieldValue;
  ...
  earchivedetrBuyerclientref?: NumberFieldValue;
  earchivedetrBuyerclientcode?: StringFieldValue;
...
/**
 * Analytics data for SalesDispatches entities
 */
export interface SalesDispatchesAnalytics {
  total: number;
  // Add SalesDispatches-specific analytics fields
}
