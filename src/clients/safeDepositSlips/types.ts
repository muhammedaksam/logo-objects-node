...
/**
 * Interface for RSCollection[RS_DistCsDetLnXML]
 */
export interface RscollectionrsDistcsdetlnxml {
  Meta?: Meta;
  items?: RsDistcsdetlnxml[];
}

/**
 * Interface for RSCollection[RS_DistDetLnXML]
 */
export interface RscollectionrsDistdetlnxml {
  Meta?: Meta;
  items?: RsDistdetlnxml[];
}
 ...
 *
 * Represents individual transaction records within a SafeDepositSlips collection.
 */
...
/**
 * RsDistcsdetlnxml transaction line item
 *
 * Represents individual transaction records within a SafeDepositSlips collection.
 */
export interface RsDistcsdetlnxml extends BaseEntity {
  CARDREF?: number;
  CASHTRANSREF?: number;
  LINE_NO?: number;
  CSDISTTEMPLINE?: number;
  ACCREF?: number;
  CENTERREF?: number;
  PROJECTREF?: number;
  DISTRATE?: number;
  ...
  PROJECTCODE?: string;
  EDTAMOUNT?: number;
  DIST_TMP_LN_TYPE?: number;
}

/**
 * RsDistdetlnxml transaction line item
 *
 * Represents individual transaction records within a SafeDepositSlips collection.
 */
export interface RsDistdetlnxml extends BaseEntity {
  CARDREF?: number;
  CASHTRANSREF?: number;
  LINE_NO?: number;
  CSDISTTEMPLINE?: number;
...
/**
 * SafeDepositSlips entity interface based on swagger definition
 */
export interface SafeDepositSlips extends BaseEntity {
  TYPE?: number;
  SD_CODE?: string;
  CARDREF?: number;
  ...
  CURRSEL_DETAILS?: number;
  TRADING_GRP?: string;
  ATTACHMENT_ARP?: RscollectionrsArptransxml;
  ATTACHMENT_BANK?: RscollectionrsBanktransxml;
  ...
  CS_DETLIST?: RscollectionrsDistcsdetlnxml;
  CS_DETDELLIST?: string;
  DETLIST?: RscollectionrsDistdetlnxml;
  DETDELLIST?: string;
  CASH_INFLDX?: number;
  CASH_ORGLOGOID?: number;
  INVOICE_ORGLOGOID?: number;
...
/**
 * Union type of all SafeDepositSlips field names for type-safe field selection and sorting
 */
export type SafeDepositSlipsField =
  | 'INTERNAL_REFERENCE'
  | 'TYPE'
  | 'SD_CODE'
  | 'CARDREF'
  ...
  | 'INC_DEDUCT_AMOUNT'
  | 'DEDUCT_CODE'
  | 'SMM_VAT_DEDUCT_ACC_CODE'
  | 'SMMVATDEDUCTACCREF'
  | 'SMM_VAT_DEDUCT_CEN_CODE'
  | 'SMMVATDEDUCTCENREF'
  | 'SMM_VAT_DEDUCT_OTH_ACC_CODE'
  | 'SMMVATDEDUCTOTHACCREF'
  | 'SMM_VAT_DEDUCT_OTH_CEN_CODE'
  | 'SMMVATDEDUCTOTHCENREF'
  | 'SALESMAN_CODE'
  | 'SALESMANREF'
  | 'CL_TR_CURR'
  | 'CL_TR_RATE'
...
/**
 * Type-safe sort specification for SafeDepositSlips queries
 */
export type SafeDepositSlipsSortSpec =
  | [SafeDepositSlipsField]
  | [SafeDepositSlipsField, 'asc' | 'desc']
  | [SafeDepositSlipsField[], 'asc' | 'desc']
  | [SafeDepositSlipsField[]];

/**
 * Type-safe query options for SafeDepositSlips entities
 *
...
export interface SafeDepositSlipsQueryOptions
   ...
   */
  sort?: SafeDepositSlipsSortSpec;
}

/**
 * Search criteria for SafeDepositSlips entities
 *
 ...
 * ```
 */
export interface SafeDepositSlipsSearchCriteria {
  internalReference?: NumberFieldValue;
  type?: NumberFieldValue;
  sdCode?: StringFieldValue;
  cardref?: NumberFieldValue;
  sdCodeCross?: StringFieldValue;
  vcardref?: NumberFieldValue;
  sdNumberCross?: StringFieldValue;
  crossDataReference?: NumberFieldValue;
  ...
  csaccref?: NumberFieldValue;
  ohpCode2?: StringFieldValue;
  cscenterref?: NumberFieldValue;
  ...
  masterTitle?: StringFieldValue;
  masterTitle2?: StringFieldValue;
  ...
  attachmentArp?: DateFieldValue;
  attachmentBank?: DateFieldValue;
  ...
  smmvatrate?: NumberFieldValue;
  incometaxrate?: NumberFieldValue;
  fundsharerate?: NumberFieldValue;
  smmdocode?: StringFieldValue;
  smmaddr?: StringFieldValue;
  numberplate?: StringFieldValue;
  optiontype?: NumberFieldValue;
  taxAccCode?: StringFieldValue;
  gptaxacc?: NumberFieldValue;
  fundAccCode?: StringFieldValue;
  fundacc?: NumberFieldValue;
  smmVatAccCode?: StringFieldValue;
  smmvatacc?: NumberFieldValue;
  xmlAttribute?: NumberFieldValue;
  inflationIdx?: NumberFieldValue;
  tranGrpNo?: StringFieldValue;
  tranGrpLineNo?: NumberFieldValue;
  csDetlist?: DateFieldValue;
  csDetdellist?: StringFieldValue;
  detlist?: DateFieldValue;
  detdellist?: StringFieldValue;
  cashInfldx?: NumberFieldValue;
  cashOrglogoid?: NumberFieldValue;
  invoiceOrglogoid?: NumberFieldValue;
  vatInc?: NumberFieldValue;
  vatRat?: NumberFieldValue;
  vatAccref?: NumberFieldValue;
  vatAccCode?: StringFieldValue;
  vatTot?: NumberFieldValue;
  ...
  posTransferInfo?: StringFieldValue;
  csTransReference?: NumberFieldValue;
  ...
  taxOhpCode?: StringFieldValue;
  smmVatOhpCode?: StringFieldValue;
  smmvatcentref?: NumberFieldValue;
  cashAccCode?: StringFieldValue;
  cashAccRef?: NumberFieldValue;
  cashOhpCode?: StringFieldValue;
  cashOhpRef?: NumberFieldValue;
  ...
  incDeductAmount?: NumberFieldValue;
  deductCode?: StringFieldValue;
  smmVatDeductAccCode?: StringFieldValue;
  smmvatdeductaccref?: NumberFieldValue;
  smmVatDeductCenCode?: StringFieldValue;
  smmvatdeductcenref?: NumberFieldValue;
  smmVatDeductOthAccCode?: StringFieldValue;
  smmvatdeductothaccref?: NumberFieldValue;
  smmVatDeductOthCenCode?: StringFieldValue;
  smmvatdeductothcenref?: NumberFieldValue;
  salesmanCode?: StringFieldValue;
  salesmanref?: NumberFieldValue;
  clTrCurr?: NumberFieldValue;
  clTrRate?: NumberFieldValue;
  clTrNet?: NumberFieldValue;
  offerReference?: NumberFieldValue;
  crcardWizard?: NumberFieldValue;
  smmSerialCode?: StringFieldValue;
  ...
  stoppageAmount?: NumberFieldValue;
  stoppageAmountTc?: NumberFieldValue;
  stoppageAmountRc?: NumberFieldValue;
  fundshareAmount?: NumberFieldValue;
  fundshareAmountTc?: NumberFieldValue;
  fundshareAmountRc?: NumberFieldValue;
  vatAmountx?: NumberFieldValue;
  vatAmountxTc?: NumberFieldValue;
  vatAmountxRc?: NumberFieldValue;
  deductionAmount?: NumberFieldValue;
  deductionAmountTc?: NumberFieldValue;
  deductionAmountRc?: NumberFieldValue;
  totalVat?: NumberFieldValue;
  totalVatTc?: NumberFieldValue;
  totalVatRc?: NumberFieldValue;
  grossAmount?: NumberFieldValue;
  grossAmountTc?: NumberFieldValue;
  grossAmountRc?: NumberFieldValue;
  netAmount?: NumberFieldValue;
  netAmountTc?: NumberFieldValue;
  netAmountRc?: NumberFieldValue;
  crossTcXrate?: NumberFieldValue;
  crossTcCurr?: NumberFieldValue;
  crossTcAmount?: NumberFieldValue;
  ...
  isperscomp?: NumberFieldValue;
  amountStr?: StringFieldValue;
...
/**
 * Analytics data for SafeDepositSlips entities
 */
export interface SafeDepositSlipsAnalytics {
  total: number;
  // Add SafeDepositSlips-specific analytics fields
}
