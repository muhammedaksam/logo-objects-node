import { DbinfoClient } from './client';
import { Dbinfo, DbinfoField, DbinfoSortSpec } from './types';
import { ApiClientConfig } from '../../types';

describe('DbinfoClient', () => {
  let client: DbinfoClient;
  ...
  beforeEach(() => {
    ...
    client = new DbinfoClient(config);
  });
  ...
  describe('Basic CRUD Operations', () => {
    ...
    it('should get all dbinfo', async () => {
      const mockResponse = {
        items: [
          {
    ...
    it('should get all dbinfo with options', async () => {
      const options = { limit: 10, offset: 0, sort: ['INTERNAL_REFERENCE'] as DbinfoSortSpec };
      await client.getAll(options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/dbinfo?limit=10&offset=0&sort=INTERNAL_REFERENCE'
      );
    });
  });
  ...
  describe('Analytics Methods', () => {
    it('should get dbinfo analytics', async () => {
    ...
    it('should get dbinfo count', async () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should get database column properties', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/dbinfo/dbcolumns');
    ...
    it('should track changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/dbinfo/track');
    ...
    it('should untrack changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/dbinfo/untrack');
    ...
    it('should check track status', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/dbinfo/checktrack');
