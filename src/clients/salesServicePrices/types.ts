 ...
 *
 * Represents individual transaction records within a SalesServicePrices collection.
 */
...
/**
 * SalesServicePrices entity interface based on swagger definition
 */
export interface SalesServicePrices extends BaseEntity {
  CARD_CODE?: string;
  OWNER_TYPE?: number;
  OWNER_CODE?: string;
  CARDREF?: number;
...
/**
 * Union type of all SalesServicePrices field names for type-safe field selection and sorting
 */
export type SalesServicePricesField =
  | 'INTERNAL_REFERENCE'
  | 'CARD_CODE'
  | 'OWNER_TYPE'
  | 'OWNER_CODE'
...
/**
 * Type-safe sort specification for SalesServicePrices queries
 */
export type SalesServicePricesSortSpec =
  | [SalesServicePricesField]
  | [SalesServicePricesField, 'asc' | 'desc']
  | [SalesServicePricesField[], 'asc' | 'desc']
  | [SalesServicePricesField[]];

/**
 * Type-safe query options for SalesServicePrices entities
 *
 ...
 * ```
 */
export interface SalesServicePricesQueryOptions
  extends Omit<QueryOptions<SalesServicePricesField>, 'fields' | 'sort'> {
  /**
   * Array of field names to include in the response
   * @example ['CODE', 'TITLE', 'STATUS']
   */
  fields?: SalesServicePricesField[];
   ...
   */
  sort?: SalesServicePricesSortSpec;
}

/**
 * Search criteria for SalesServicePrices entities
 *
 ...
 * ```
 */
export interface SalesServicePricesSearchCriteria {
...
/**
 * Analytics data for SalesServicePrices entities
 */
export interface SalesServicePricesAnalytics {
  total: number;
  // Add SalesServicePrices-specific analytics fields
}
