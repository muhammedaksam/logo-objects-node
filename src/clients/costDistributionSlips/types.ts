 ...
 *
 * Represents individual transaction records within a CostDistributionSlips collection.
 */
...
/**
 * CostDistributionSlips entity interface based on swagger definition
 */
export interface CostDistributionSlips extends BaseEntity {
  FICHENO?: string;
  DATE?: string;
  FTIME?: number;
  DOCODE?: string;
...
/**
 * Union type of all CostDistributionSlips field names for type-safe field selection and sorting
 */
export type CostDistributionSlipsField =
  | 'INTERNAL_REFERENCE'
  | 'FICHENO'
  | 'DATE'
  | 'FTIME'
...
/**
 * Type-safe sort specification for CostDistributionSlips queries
 */
export type CostDistributionSlipsSortSpec =
  | [CostDistributionSlipsField]
  | [CostDistributionSlipsField, 'asc' | 'desc']
  | [CostDistributionSlipsField[], 'asc' | 'desc']
  | [CostDistributionSlipsField[]];

/**
 * Type-safe query options for CostDistributionSlips entities
 *
...
> {
   ...
   */
  fields?: CostDistributionSlipsField[];
   ...
   */
  sort?: CostDistributionSlipsSortSpec;
}

/**
 * Search criteria for CostDistributionSlips entities
 *
 ...
 * ```
 */
export interface CostDistributionSlipsSearchCriteria {
...
/**
 * Analytics data for CostDistributionSlips entities
 */
export interface CostDistributionSlipsAnalytics {
  total: number;
  // Add CostDistributionSlips-specific analytics fields
}
