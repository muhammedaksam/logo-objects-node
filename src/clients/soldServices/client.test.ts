import { SoldServicesClient } from './client';
import { SoldServices, SoldServicesField, SoldServicesSortSpec } from './types';
import { ApiClientConfig } from '../../types';

describe('SoldServicesClient', () => {
  let client: SoldServicesClient;
  ...
  beforeEach(() => {
    ...
    client = new SoldServicesClient(config);
  });
  ...
  describe('Basic CRUD Operations', () => {
    ...
    it('should get all soldServices', async () => {
      const mockResponse = {
        items: [
          {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices');
      expect(result).toEqual(mockResponse);
    });

    it('should get all soldServices with options', async () => {
      const options = { limit: 10, offset: 0, sort: ['CARD_TYPE'] as SoldServicesSortSpec };
      await client.getAll(options);

      expect(client['request']).toHaveBeenCalledWith(
        'get',
        '/soldServices?limit=10&offset=0&sort=CARD_TYPE'
      );
    });

    it('should get soldServices by ID', async () => {
      const mockSoldServices: SoldServices = {
        INTERNAL_REFERENCE: 1,
        CODE: 'Test CODE',
        DESCRIPTION: 'Test DESCRIPTION',
      };
      jest.spyOn(client, 'request' as any).mockResolvedValue(mockSoldServices);

      const result = await client.getById(1);

      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices/1');
      expect(result).toEqual(mockSoldServices);
    });

    it('should get soldServices by ID with options', async () => {
      const options = { expandLevel: 'full' };
      await client.getById(1, options);

      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices/1?expandLevel=full');
    });

    it('should create a new soldServices', async () => {
      const newSoldServices = {
        CODE: 'Test CODE',
        DESCRIPTION: 'Test DESCRIPTION',
      };
      const createdSoldServices: SoldServices = { ...newSoldServices, INTERNAL_REFERENCE: 1 };
      jest.spyOn(client, 'request' as any).mockResolvedValue(createdSoldServices);

      const result = await client.create(newSoldServices);

      expect(client['request']).toHaveBeenCalledWith('post', '/soldServices', newSoldServices);
      expect(result).toEqual(createdSoldServices);
    });

    it('should update a soldServices', async () => {
      const updateSoldServices = {
        INTERNAL_REFERENCE: 1,
        CODE: 'Test CODE',
        DESCRIPTION: 'Test DESCRIPTION',
      };
      jest.spyOn(client, 'request' as any).mockResolvedValue(updateSoldServices);

      const result = await client.update(1, updateSoldServices);

      expect(client['request']).toHaveBeenCalledWith('put', '/soldServices/1', updateSoldServices);
      expect(result).toEqual(updateSoldServices);
    });

    it('should patch a soldServices', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('patch', '/soldServices/1', patchData);
      expect(result).toEqual({ success: true });
    });

    it('should delete a soldServices', async () => {
      jest.spyOn(client, 'request' as any).mockResolvedValue({ success: true });

      const result = await client.delete(1);

      expect(client['request']).toHaveBeenCalledWith('delete', '/soldServices/1');
      expect(result).toEqual({ success: true });
    });
  });
  ...
  describe('Search Methods', () => {
    ...
    it('should search soldServices', async () => {
  ...
  describe('Analytics Methods', () => {
    it('should get soldServices analytics', async () => {
    ...
    it('should get soldServices count', async () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should get database column properties', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices/dbcolumns');
    ...
    it('should track changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices/track');
    ...
    it('should untrack changes', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices/untrack');
    ...
    it('should check track status', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', '/soldServices/checktrack');
  ...
  describe('Error Handling', () => {
    it('should handle API errors gracefully', async () => {
      const apiError = new Error('API Error: SoldServices not found');
      jest.spyOn(client, 'request' as any).mockRejectedValue(apiError);

      await expect(client.getById(999)).rejects.toThrow('API Error: SoldServices not found');
    });
  ...
  describe('Custom Endpoint Methods', () => {
    it('should call importImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ImportImage/test/test`
      );
      expect(result).toEqual({ success: true });
    });

    it('should call importImageV1 with query options', async () => {
      const options = { limit: 10, fields: ['CARD_TYPE', 'CODE'] as SoldServicesField[] };
      jest.spyOn(client, 'request' as any).mockResolvedValue({ success: true });
    ...
    it('should call importImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ImportImage/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportBase64EncodedImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ExportBase64EncodedImage/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportBase64EncodedImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ExportBase64EncodedImage/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importBase64EncodedImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ImportBase64EncodedImage/test/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importBase64EncodedImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ImportBase64EncodedImage/test/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call formSeriLotLinesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/FormSeriLotLines/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call formSeriLotLinesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/FormSeriLotLines/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ApplyCampaign`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ApplyRePayPln/1/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ApplyRePayPln/1/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnForInvV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ApplyRePayPlnForInv/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyRePayPlnForInvV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ApplyRePayPlnForInv/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXmlStrV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ImportFromXmlStr/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXmlStrV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ImportFromXmlStr/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXmlStrV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ExportToXmlStr/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXmlStrV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ExportToXmlStr/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyConditionV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ApplyCondition`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportImageV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ExportImage/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportImageV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ExportImage/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call reCalculateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ReCalculate`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call reCalculateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('post', `/soldServices/ReCalculate`, mockData);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillAccCodesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/FillAccCodes`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyADiscountV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ApplyADiscount/test`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyADiscountV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ApplyADiscount/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setDefIntValueV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/SetDefIntValue/test/1/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setDefIntValueV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/SetDefIntValue/test/1/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call equalizePayAmntV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/EqualizePayAmnt`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addSeriLotsForKsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/AddSeriLotsForKs/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addSeriLotsForKsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/AddSeriLotsForKs/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call fillSMMACCCodesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/FillSMMACCCodes`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByLRefV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/AttachADespatchByLRef/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByLRefV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/AttachADespatchByLRef/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByFicheNoV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/AttachADespatchByFicheNo/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call attachADespatchByFicheNoV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/AttachADespatchByFicheNo/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call deleteCampaignV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/DeleteCampaign`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call setClientInfoV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/SetClientInfo`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getRelevantCampaignsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/GetRelevantCampaigns`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getRelevantCampaignsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GetRelevantCampaigns`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignSpecificV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ApplyCampaignSpecific/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call applyCampaignSpecificV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ApplyCampaignSpecific/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsApplyaccdisttemplateV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsApplyaccdisttemplateV1Get', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/UNITS/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/UNITS/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getGL_LINKSV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/GL_LINKS`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getGL_LINKSByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/GL_LINKS/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/GL_LINKS/AppendLine2`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/GL_LINKS/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/GL_LINKS/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/GL_LINKS/AddLine2/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/GL_LINKS/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/GL_LINKS/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/GL_LINKS/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/GL_LINKS/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call glLinksSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/GL_LINKS/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getADDTAXLISTV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ADDTAXLIST`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getADDTAXLISTByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/ADDTAXLIST/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/AddLine2/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ADDTAXLIST/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call addtaxlistSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ADDTAXLIST/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXMLV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ExportToXML/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call exportToXMLV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ExportToXML/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXMLFileV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/ImportFromXMLFile/test/test`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call importFromXMLFileV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/ImportFromXMLFile/test/test`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call createCompositeLinesV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/CreateCompositeLines`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call createCompositeLinesV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/CreateCompositeLines`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call postReadWithBodyParametersV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/readwithbodyparamters`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call postReadByIdWithBodyParametersV1 with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/1/readwithbodyparamters`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getWH_PARAMSV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/WH_PARAMS`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getWH_PARAMSByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/WH_PARAMS/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/AppendLine2`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/WH_PARAMS/AddLine2/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAddline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/AddLine2/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsApplyaccdisttemplateV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/ApplyAccDistTemplate/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsApplyaccdisttemplateV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/ApplyAccDistTemplate/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsSetlinetotalsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/WH_PARAMS/SetLineTotals/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call whParamsSetlinetotalsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/WH_PARAMS/SetLineTotals/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getUNITSV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/UNITS`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call getUNITSByIdV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/UNITS/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAppendline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/UNITS/AppendLine2`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAppendline2V1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/AppendLine2`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAddserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/UNITS/AddSeriLots/test/1/test/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAddserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/AddSeriLots/test/1/test/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsGetstocklinepriceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/UNITS/GetStockLinePrice/1/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsGetstocklinepriceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/GetStockLinePrice/1/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAddline2V1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith('get', `/soldServices/1/UNITS/AddLine2/1`);
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAppendserilotsV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/UNITS/AppendSeriLots/test/1/1/test/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsAppendserilotsV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/AppendSeriLots/test/1/1/test/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsEqualizebalanceV1', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'get',
        `/soldServices/1/UNITS/EqualizeBalance/1`
      );
      expect(result).toEqual({ success: true });
    });
    ...
    it('should call unitsEqualizebalanceV1Post with data', async () => {
      ...
      expect(client['request']).toHaveBeenCalledWith(
        'post',
        `/soldServices/UNITS/EqualizeBalance/1`,
        mockData
      );
      expect(result).toEqual({ success: true });
    });
