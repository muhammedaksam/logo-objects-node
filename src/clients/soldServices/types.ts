 ...
 *
 * Represents individual transaction records within a SoldServices collection.
 */
...
/**
 * SoldServices entity interface based on swagger definition
 */
export interface SoldServices extends BaseEntity {
  CARD_TYPE?: number;
  CODE?: string;
  PARENTSRVREF?: number;
  PARENT_CODE?: string;
...
/**
 * Union type of all SoldServices field names for type-safe field selection and sorting
 */
export type SoldServicesField =
  | 'INTERNAL_REFERENCE'
  | 'RECORD_STATUS'
  | 'CARD_TYPE'
  | 'CODE'
...
/**
 * Type-safe sort specification for SoldServices queries
 */
export type SoldServicesSortSpec =
  | [SoldServicesField]
  | [SoldServicesField, 'asc' | 'desc']
  | [SoldServicesField[], 'asc' | 'desc']
  | [SoldServicesField[]];

/**
 * Type-safe query options for SoldServices entities
 *
...
> {
   ...
   */
  sort?: SoldServicesSortSpec;
}

/**
 * Search criteria for SoldServices entities
 *
 ...
 * ```
 */
export interface SoldServicesSearchCriteria {
...
/**
 * Analytics data for SoldServices entities
 */
export interface SoldServicesAnalytics {
  total: number;
  // Add SoldServices-specific analytics fields
}
